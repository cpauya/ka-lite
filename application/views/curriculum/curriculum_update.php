		...
		<form class="form-horizontal" action="<?=$action_url?>" method="POST">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<textarea name="curriculum_description" class="form-control"><?=$curriculum['curriculum_description']?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="inputCurriculumYear" class="form-control" name="curriculum_year" value="<?=$curriculum['curriculum_year']?>" placeholder="Year">
					</div>
				</div>
