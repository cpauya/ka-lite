		...
		<form class="form-horizontal" action="<?=$action_url?>" method="POST">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputCourseName" placeholder="Course Name" name="course_name" value="<?=$course['course_name']?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputCourseAbbrev" placeholder="Course Abbreviation" name="course_abbrev" value="<?=$course['course_abbrev']?>">
					</div>
				</div>
