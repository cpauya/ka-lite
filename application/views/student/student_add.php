		...
		<form class="form-horizontal" action="<?=$action_url?>" method="POST">
			<fieldset>
				...
				<div class="form-group <?php if(form_error('student_firstname')) echo 'has-error'; ?>">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputFirstName" placeholder="First Name" name="student_firstname" value="<?=set_value('student_firstname')?>">
					</div>
				</div>
				...
				<div class="form-group <?php if(form_error('student_middlename')) echo 'has-error'; ?>">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputMiddleName" placeholder="Middle Name" name="student_middlename" value="<?=set_value('student_middlename')?>">
					</div>
				</div>
				...
				<div class="form-group <?php if(form_error('student_lastname')) echo 'has-error'; ?>">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputLastName" placeholder="Last Name" name="student_lastname" value="<?=set_value('student_lastname')?>">
					</div>
				</div>
