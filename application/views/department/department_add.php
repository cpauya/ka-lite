		...
		<form class="form-horizontal" action="<?=$action_url?>" method="POST">
			<fieldset>
					...
					<div class="col-sm-5">
						<select name="college_id" class="form-control" id="inputCollege">
							...
							<?php foreach($colleges as $college): ?>
								<?php if($this->input->get('id', true) == $college['college_id']): ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputDepartmentName" placeholder="Department Name" name="department_name" value="<?=set_value('department_name')?>">
					</div>
				</div>
