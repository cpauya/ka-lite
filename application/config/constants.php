...
defined('SALT_PREFIX')				OR define('SALT_PREFIX', 'd+xjf@yB');
defined('SALT_SUFFIX')				OR define('SALT_SUFFIX', 'nBu_!$kl');
defined('ADMIN')					OR define('ADMIN', 1);
defined('STUDENT')					OR define('STUDENT', 2);
defined('VALIDATION_PREFIX')		OR define("VALIDATION_PREFIX", 
	"<div class='row'>
...
defined('VALIDATION_SUFFIX')		OR define("VALIDATION_SUFFIX", "</div></div></div>");
